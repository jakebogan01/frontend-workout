...
<form on:submit|preventDefault={handleSubmit} class="create">
     ...
     <input type="text" onChange={(e) => (inputValues.title = e.target.value)} name="title" id="title" bind:value={inputValues.title} class:error={emptyFields.includes('title')} />
     
     <label for="load">Load (in Kg):</label>
     <input type="number" onChange={(e) => (inputValues.load = e.target.value)} name="load" id="load" bind:value={inputValues.load} class:error={emptyFields.includes('load')} />

     <label for="reps">Reps:</label>
     <input type="number" onChange={(e) => (inputValues.reps = e.target.value)} name="reps" id="reps" bind:value={inputValues.reps} class:error={emptyFields.includes('reps')} />
